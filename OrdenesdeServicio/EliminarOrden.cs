...
namespace OrdenesdeServicio
{
    public partial class EliminarOrden : Form
    {
        ...
        string consecutiv;
        public EliminarOrden(string consec)
        {
            consecutiv = consec;
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string q = "delete  tblOrden.* from tblOrden WHERE tblOrden.consecutivo=@Numero and tblOrden.Usuario='" + consecutiv + "' ";
                ...
                string u = "delete  Abono.* from Abono WHERE Abono.Consecutivo=@Numero and Abono.Usuario='" + consecutiv + "' ";


                OleDbCommand comand = new OleDbCommand(u, conexion);
                comand.Connection.Open();


                comand.Parameters.AddWithValue("@Numero", consecutivo);

                /// comando.Parameters.Add(new OleDbParameter("@fechafactura", OleDbType.Date));
                ///comando.Parameters["@fechafactura"].Value = fecha1;
                OleDbDataReader du = comand.ExecuteReader();
                ...
                string a = "delete  tblDetalleOrden.* from tblDetalleOrden WHERE tblDetalleOrden.Codigo=@Numero and tblDetalleOrden.Usuario='" + consecutiv + "' "; 

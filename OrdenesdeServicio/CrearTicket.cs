...
namespace OrdenesdeServicio
{
    ...
    public class CrearTicket
    {
        ...
        public void EncabezadoVenta()
        {
            ...
            Linea.AppendLine("DESCRIPCION     PLUG |CANT |PRECIO");
        }
        ...
        public void AgregaArticulo(string articulo, int cant, decimal precio, decimal importe)
        {
            ...
            if (cant.ToString().Length <= 6 && precio.ToString().Length <= 4 && importe.ToString().Length <= 8)
            {
                ...
                if (articulo.Length > 17)
                {
                    ...
                    nroEspacios = (12- importe.ToString().Length);
                    espacios = "";
                    for (int i = 0; i < nroEspacios; i++)
                    {
                        espacios += " ";
                ...
                else //Si no es mayor solo agregarlo, sin dar saltos de lineas
                {
                    ...
                    //Colocar el precio a la derecha.
                    nroEspacios = (4 - precio.ToString().Length);
                    espacios = "";
                    for (int i = 0; i < nroEspacios; i++)
                    {
                        espacios += " ";

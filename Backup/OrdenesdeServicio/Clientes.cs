...
namespace OrdenesdeServicio
{
    public partial class Clientes : Form
    {
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            string q = "update tblCliente set Primernombre='" + PrimerNombre + "',Segundonombre='" + segundonombre + "',Primerapellido='" + primerapellido + "',Segundoapellido='" + segundoapellido + "',Telefono='" + Telefono + "',Telofc='" + telofc + "',Ext='" + ext + "',Direccion='" + Direccion + "',Contacto='" + Contacto + "',Email='" + Email + "',Nombrecompleto='" + nombrecompleto + "' where Documento=@Documento";
